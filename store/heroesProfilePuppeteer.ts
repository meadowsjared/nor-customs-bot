...
async function scrapePlayerStats(browser: Browser, url: string, battleTag: string): Promise<HPData> {
  ...
  const qmMmrSelector =
    '#app > div:nth-child(7) > div:nth-child(4) > div:nth-child(5) > div.mx-auto > div:nth-child(1) > div:nth-child(4) > div > div';
  const slMmrSelector =
    '#app > div:nth-child(7) > div:nth-child(4) > div:nth-child(5) > div.mx-auto > div:nth-child(5) > div:nth-child(4) > div > div';
  const arMmrSelector =
    '#app > div:nth-child(7) > div:nth-child(4) > div:nth-child(5) > div.mx-auto > div:nth-child(6) > div:nth-child(4) > div > div';
  const gameTypeDropdown = '#app > div:nth-child(7) > div:nth-child(2) > div:nth-child(1) > div > span:nth-child(2)';
  const qmGameTypeSelector = '#qm';
  const slGameTypeSelector = '#sl';
  const arGameTypeSelector = '#ar';
  const filterButton = '#app > div:nth-child(7) > div.flex.justify-center.mx-auto > button';
  const winsSelector =
    '#app > div:nth-child(7) > div:nth-child(4) > div.flex.md\\:p-20.gap-10.mx-auto.justify-center.items-between.max-md\\:flex-col.max-md\\:items-center > div.flex-1.flex.flex-wrap.justify-between.max-w-\\[400px\\].w-full.items-between.mt-\\[1em\\].max-md\\:order-1 > div:nth-child(1) > div > div';
  const lossesSelector =
    '#app > div:nth-child(7) > div:nth-child(4) > div.flex.md\\:p-20.gap-10.mx-auto.justify-center.items-between.max-md\\:flex-col.max-md\\:items-center > div.flex-1.flex.flex-wrap.justify-between.max-w-\\[400px\\].w-full.items-between.mt-\\[1em\\].max-md\\:order-1 > div:nth-child(2) > div > div';
  const noDataSelector =
    '#app > div:nth-child(7) > div.flex.md\\:p-20.gap-10.mx-auto.justify-center.items-between > div > span';
  ...
  while (attempts < maxAttempts) {
    try {
      ...
      arMmr = await getMMR(page, playerName, 'ARAM');

      console.log(`${playerName}: QM MMR: ${qmMmr}, SL MMR: ${slMmr}, AR MMR: ${arMmr}`);
      ...
      return { region, blizz_id, qmMmr, slMmr, qmGames, slGames, arMmr, arGames };
    } catch (error: any) {
      // take a screenshot
...
export async function getHeroesProfileDataPuppeteer(battleTag: string): Promise<HPData | undefined> {
  try {
